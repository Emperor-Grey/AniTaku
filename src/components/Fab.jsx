...
import {Calendar, More2, SearchNormal1, TableDocument} from 'iconsax-react-native';
...
const Fab = () => {
    ...
    const popIn = () => {
        ...
        Animated.timing(icon_1, {
            toValue: 120, duration: 150, useNativeDriver: false,
        }).start();
        Animated.timing(icon_2, {
            toValue: 100, duration: 350, useNativeDriver: false,
        }).start();
        Animated.timing(icon_3, {
            toValue: 120, duration: 420, useNativeDriver: false,
        }).start();
    };
    ...
    const popOut = () => {
        setPop(false);
        Animated.timing(icon_1, {
            toValue: 20, duration: 500, useNativeDriver: false,
        }).start();
        Animated.timing(icon_2, {
            toValue: 20, duration: 500, useNativeDriver: false,
        }).start();
