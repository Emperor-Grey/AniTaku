...
const RowItem = props => {
        ...
        return (<TouchableOpacity
                ...
                <ImageBackground
                    ...
                    <View className="flex-1 items-start justify-start p-2">
                        <Pressable
                            className="bg-lime-200 px-1 py-[2] rounded-full flex-row items-center justify-center space-x-1">
                            {item.rating ? (<>
                ...
                <Text
                    ...
                    {item.rating ? item.title.english && item.title.english.length <= 16 ? item.title.english : item.title.english ? `${item.title.english.slice(0, 14)}...` : 'No Name' : item.title.romaji.romaji && item.title.romaji.length <= 16 ? item.title.romaji : item.title.romaji ? `${item.title.romaji.slice(0, 14)}...` : 'No Name'}
                </Text>
            </TouchableOpacity>);
    };
    ...
    return (<View className="px-2 mb-2">
...
const styles = StyleSheet.create({
    image: {
        borderRadius: 18, overflow: 'hidden', width: responsiveWidth(34.5), height: responsiveHeight(22.6),
    }, imageModel: {
        borderRadius: 18, overflow: 'hidden', width: responsiveWidth(31), height: responsiveHeight(21),
    }, modelHeight: {
        padding: 0, margin: 0, height: responsiveHeight(54), width: responsiveWidth(100),
    },
});
