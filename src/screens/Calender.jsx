...
export default function Calender() {
    ...
    const weeks = React.useMemo(() => {
        ...
        return [-1, 0, 1].map(adj => {
            return Array.from({length: 7}).map((_, index) => {
                ...
                return {
                    weekday: date.format('ddd'), date: date.toDate(),
                };
            });
        });
    }, [week]);
    ...
    if (loading) {
        return (<View className="bg-neutral-950 flex-1 justify-center items-center">
                <LottieView
    ...
    return (<SafeAreaView className="flex-1 bg-neutral-900">
...
const styles = StyleSheet.create({
    title: {
        ...
        flexGrow: 1, flexShrink: 1, flexBasis: 0, height: 400, marginTop: 0, padding: 0,
    }, placeholderInset: {
        borderWidth: 2,
        borderColor: 'green',
        borderStyle: 'dashed',
        ...
        fontSize: 18, lineHeight: 26, fontWeight: '600', color: '#fff',
    }, container: {
        flex: 1, paddingVertical: 24,
    }, picker: {
        flex: 1, maxHeight: 80, paddingVertical: 12, flexDirection: 'row', alignItems: 'center',
    }, subtitle: {
        ...
        fontSize: 13, fontWeight: '500', marginBottom: 4, color: 'white',
    }, itemDate: {
