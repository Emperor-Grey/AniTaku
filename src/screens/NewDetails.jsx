...
const NewDetails = ({route}) => {
    ...
    useEffect(() => {
        const fetchAnimeDetails = async id => {
            try {
                const details = await getAnimeInfo(id);
    ...
    return (<ScrollView className="flex-1 bg-neutral-950">
            ...
            <View className="flex-1 bg-neutral-950 p-2">
                ...
                <EpisodeRow
                    mainData={animeDetails.episodes.data.filter(i => i.providerId === 'gogoanime') || []}
...
const styles = StyleSheet.create({
    image: {
        resizeMode: 'stretch', width: responsiveWidth(100), height: responsiveHeight(62.5),
    }, center: {
